...
namespace phoeg {
    ...
    struct vf2_find_stop_callback {
        ...
        {
            /* Use a side effet to tell the caller that a mapping was found
             * because the default return scheme for vf2_subgraph_mono seems to
             * be buggy. */
            *_found = true;
            return false;
        }
    ...
    /* Graphs have to be stored as an adjacency list for this function
     * to work. */
    ...
    /* Graphs have to be stored as an adjacency list for this
     * function to work. */
    template <class Graph>
